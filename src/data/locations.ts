...
export const LOCATIONS_ROOT_META = {
  ...
  description:
    "Areas we serve: Surrey and South West London SME accounting from Figures, Woking-based. Town pages, services and local business support.",
} as const;
