    ...
    <section className="bg-slate-50 px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
      <div className="mx-auto max-w-3xl">
        ...
        <p className="mt-6 text-lg text-slate-600">
          Josh co-founded Figures Chartered Accountants in 2023 after building his career at EY (restructuring), Barclays, and Crown Agents Bank. He brings big-firm rigour and small-team responsiveness so you get advice you can trust, without the corporate runaround.
        </p>
        <Link
          href="/about"
